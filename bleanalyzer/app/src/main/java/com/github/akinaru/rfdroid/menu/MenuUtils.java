...
import com.github.akinaru.rfdroid.activity.RFdroidActivity;
...
public class MenuUtils {
     ...
     */
    public static void selectDrawerItem(MenuItem menuItem, DrawerLayout mDrawer, Context context, IBtActivity activity) {
